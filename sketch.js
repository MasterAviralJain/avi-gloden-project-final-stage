...
//call different zombies group
    if (frameCount % 90 === 0){
        ...
        if(zombieG.isTouching(man)||zombie2G.isTouching(man)||zombie3G.isTouching(man)||zombie3G.isTouching(man)||zombie4G.isTouching(man)||zombie5.isTouching(man)){
            life=life-25;
        }

        if(life===0){
            textSize(32);
            text("Game Over",displayWidth-displayWidth/2,displayHeight-displayHeight/1.6)
        }
